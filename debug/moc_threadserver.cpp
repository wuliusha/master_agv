...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_threadServer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_threadServer_t qt_meta_stringdata_threadServer = {
    {
QT_MOC_LITERAL(0, 0, 12), // "threadServer"
QT_MOC_LITERAL(1, 13, 17), // "threadServerTimer"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "threadServer\0threadServerTimer\0"
};
...
void threadServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<threadServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->threadServerTimer(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject threadServer::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_threadServer.data,
    qt_meta_data_threadServer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *threadServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_threadServer.stringdata0))
