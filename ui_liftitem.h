/********************************************************************************
** Form generated from reading UI file 'liftitem.ui'
**
...
#ifndef UI_LIFTITEM_H
#define UI_LIFTITEM_H
...
public:
    ...
    void setupUi(QWidget *liftItem)
    {
        if (liftItem->objectName().isEmpty())
            liftItem->setObjectName(QString::fromUtf8("liftItem"));
        liftItem->resize(272, 262);
        liftItem->setMinimumSize(QSize(260, 260));
        liftItem->setMaximumSize(QSize(272, 262));
        liftItem->setStyleSheet(QString::fromUtf8("color: white;  \n"
"border: 2px groove gray;\n"
"border-radius:15px;border:none;\n"
"background-color: rgb(0, 166, 172);"));
        gridLayout = new QGridLayout(liftItem);
        ...
        label_Info = new QLabel(liftItem);
...
"border-radius:15px;padding:15px 30px;"));
        ...
        enable_Button = new QPushButton(liftItem);
...
"border-radius:5px;padding:5px 10px;"));
        ...
        reset_Button = new QPushButton(liftItem);
...
"border-radius:5px;padding:5px 10px;"));
        ...
        forward_Button = new QPushButton(liftItem);
...
"border-radius:5px;padding:5px 10px;"));
        ...
        late_Button = new QPushButton(liftItem);
...
"border-radius:5px;padding:5px 10px;"));
        ...
        retranslateUi(liftItem);

        QMetaObject::connectSlotsByName(liftItem);
    } // setupUi

    void retranslateUi(QWidget *liftItem)
    {
        liftItem->setWindowTitle(QApplication::translate("liftItem", "Form", nullptr));
        cageId->setText(QString());
        label_Info->setText(QString());
        label_22->setText(QApplication::translate("liftItem", " \344\274\240\346\204\237\345\231\2501", nullptr));
        sensor_1->setText(QString());
        label_24->setText(QApplication::translate("liftItem", " \344\274\240\346\204\237\345\231\2502", nullptr));
        sensor_2->setText(QString());
        enable_Button->setText(QApplication::translate("liftItem", "\344\275\277\347\224\250", nullptr));
        reset_Button->setText(QApplication::translate("liftItem", "\345\244\215\344\275\215", nullptr));
        forward_Button->setText(QApplication::translate("liftItem", "\345\274\200\351\227\250", nullptr));
        late_Button->setText(QApplication::translate("liftItem", "\345\205\263\351\227\250", nullptr));
    } // retranslateUi

};

namespace Ui {
    class liftItem: public Ui_liftItem {};
} // namespace Ui
