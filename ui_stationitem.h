...
public:
    ...
    void setupUi(QWidget *stationItem)
    {
        ...
        stationItem->resize(265, 260);
        stationItem->setMinimumSize(QSize(260, 260));
        stationItem->setMaximumSize(QSize(265, 260));
        stationItem->setStyleSheet(QString::fromUtf8("color: white;  \n"
"border: 2px groove gray;\n"
"border-radius:15px;border:none;\n"
"background-color: rgb(0, 166, 172);"));
        gridLayout = new QGridLayout(stationItem);
        ...
        label_Info = new QLabel(stationItem);
...
""));
        ...
        label_22 = new QLabel(stationItem);
        ...
        sensor_1 = new QLabel(stationItem);
...
"border-radius:15px;padding:15px 30px;"));
        ...
        label_24 = new QLabel(stationItem);
        ...
        sensor_2 = new QLabel(stationItem);
...
"border-radius:15px;padding:15px 30px;"));
        ...
        enable_Button = new QPushButton(stationItem);
...
"border-radius:5px;padding:5px 10px;"));
        ...
        reset_Button = new QPushButton(stationItem);
...
"border-radius:5px;padding:5px 10px;"));
        ...
        forward_Button = new QPushButton(stationItem);
...
"border-radius:5px;padding:5px 10px;"));
        ...
        late_Button = new QPushButton(stationItem);
...
"border-radius:5px;padding:5px 10px;"));
    ...
    void retranslateUi(QWidget *stationItem)
    {
        ...
        label_22->setText(QApplication::translate("stationItem", " \344\274\240\346\204\237\345\231\2501", nullptr));
        sensor_1->setText(QString());
        label_24->setText(QApplication::translate("stationItem", " \344\274\240\346\204\237\345\231\2502", nullptr));
        sensor_2->setText(QString());
        enable_Button->setText(QApplication::translate("stationItem", "\344\275\277\347\224\250", nullptr));
        reset_Button->setText(QApplication::translate("stationItem", "\345\244\215\344\275\215", nullptr));
        forward_Button->setText(QApplication::translate("stationItem", "\345\274\200\351\227\250", nullptr));
        late_Button->setText(QApplication::translate("stationItem", "\345\205\263\351\227\250", nullptr));
    } // retranslateUi
